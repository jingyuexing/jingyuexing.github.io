/**
 * [searchOnionLinks description]
 * @param  {any[]} data       data
 * @param  {string} searchTerm search term
 * @return {any[]}            search result
 */
function searchLinks(data, searchTerm) {
...
main.controller("kindCtrl", [
	...
	function ($scope, $http) {
		...
		$scope.$watch("search", function (newValue, oldValue, scope) {
			scope.links = searchLinks(scope.backup, newValue);
		});
	},
]);
